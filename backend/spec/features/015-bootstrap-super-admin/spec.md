...
- Cualquier cambio en `otaway-ionic` — ese repositorio consume este contrato desde su propia feature `005-gestion-usuarios` y depende de que esta feature esté implementada antes de considerar segura la asignación de roles desde su UI; no se toca ese repo desde aquí.

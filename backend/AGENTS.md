...
OtaWay es un **backend SaaS multi-tenant** para gestión y agendamiento de espacios deportivos. Exclusivamente API REST — **cero frontend, cero páginas visuales, cero React fuera de lo que Next.js exige internamente**.

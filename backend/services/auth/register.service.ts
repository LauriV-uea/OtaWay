...
/**
 * Orquesta el registro público (feature 016): valida unicidad en OtaWay antes de gastar una
 * llamada a Keycloak, crea la identidad real ahí, y luego crea el registro en OtaWay. Si el
 * paso de OtaWay falla después de haber creado el usuario en Keycloak, revierte (elimina) ese
	...
	try {
		...
		try {
			...
			logger.error(
				...
				'No se pudo revertir la creación del usuario en Keycloak tras un fallo en OtaWay — requiere limpieza manual.',
			);
		}

...
// crear la identidad real de un usuario. Usa el cliente de servicio `otaway-registration-service`
...
/** Compensación: si el paso posterior en OtaWay falla, se revierte la creación en Keycloak. */

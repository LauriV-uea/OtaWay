...
const envSchema = z.object({
	...
	// Cliente publico para la app movil (otaway-ionic, Capacitor): sin secreto, login con
	...
	SESSION_COOKIE_NAME: z.string().min(1).default('otaway_session'),
	SESSION_TEMP_COOKIE_NAME: z.string().min(1).default('otaway_oauth_state'),

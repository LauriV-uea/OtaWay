# Copilot Instructions — OtaWay

OtaWay es un backend SaaS multi-tenant para gestión de espacios deportivos. Es **exclusivamente API REST** — sin frontend, sin páginas React, sin CSS, sin componentes UI.
